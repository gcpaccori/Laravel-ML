...
class CampaniaEtapaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "peso_promedio_inicial_gr" => 'nullable|decimal:0,2',
            "peso_promedio_final_gr" => 'nullable|decimal:0,2',
    ...
    public function messages(): array
    {
        return [
            ...
            'peso_promedio_inicial_gr.decimal' => 'El peso promedio debe tener máximo 2 decimales.',
            'peso_promedio_final_gr.decimal' => 'El peso promedio debe tener máximo 2 decimales.',
